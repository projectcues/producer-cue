...
export function getInsertAreas() {
    const insertAreas = [];
    Array.from(document.querySelectorAll('[data-id]:not([data-component]):has(> :not([data-component]))'))
        ...
        const siblings = Array.from(parent.children).filter((c) => c.hasAttribute('data-node-id') &&
        ...
        const isBlockLayout = siblings.length > 1 &&
            siblings
 ...
 */
function offsetDropLines(insertAreas) {
        ...
        if (area.layout === 'block') {
            return {
                ...
                point: {
                    ...area.center,
                    y: area.center.y -
                        insertAreas.filter((area2) => area.parent !== area2.parent &&
                            area2.layout === 'block' &&
                            area2.center.y === area.center.y &&
                            area2.parent.contains(area.parent)).length *
                            area.direction,
                },
            };
        }
...
//# sourceMappingURL=getInsertAreas.js.map